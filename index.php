...
?>
<link rel="stylesheet" type="text/css" href="assets/css/shop-styles.css?<?php echo time(); ?>" />
<link rel="stylesheet" type="text/css" href="vendor/bootstrap/c?<?php echo time(); ?>" />
<style>
.card {
	background-image: url("C:\xampp\htdocs\xampp\inventory\assets\images\bg.jpg") ;
